package com.example.zafar.sartcrowd.SharedPreference;
...
import com.example.zafar.sartcrowd.activity.PhoneAuthActivity;
...
public class SessionManager {
    ...
    public void setStoreLocation(String store_location){
        editor.putString("store_location", store_location);
        editor.commit();
    }
    ...
    public String getStoreLocation(){
        return pref.getString("store_location", null);
    }
    public String getUserLocation(){
        return pref.getString("user_location", null);
    }
    public String getWallet(){
        return pref.getString("wallet", null);
    }
